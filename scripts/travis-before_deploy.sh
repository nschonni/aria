...
cp -R testfiles /tmp/aria-practices
...
curl "https://labs.w3.org/spec-generator/?type=respec&url=https://rawgit.com/${TRAVIS_REPO_SLUG}/master/index.html" -o index.html -f --retry 3
